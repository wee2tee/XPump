...
namespace XPump.Misc
{
    ...
    public static class Helper
    {
        ...
        public static decimal GetPurVatFromExpress(this salessummary sales, SccompDbf working_express_db, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
        ...
        public static saleshistoryVM SetMitBeg(this saleshistoryVM sales, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
        ...
        public static List<saleshistoryVM> SetMitBeg(this IEnumerable<saleshistoryVM> sales, DbConnectionConfig db_conn_config)
        {
            List<saleshistoryVM> sales_vm = new List<saleshistoryVM>();
            foreach (var s in sales)
            {
                sales_vm.Add(s.SetMitBeg(db_conn_config));
            }
        ...
        public static void SetLastestPrice(this stmasPriceVM stmas_price, DateTime price_date, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
        ...
        public static void SetLatestPrice(this IEnumerable<stmasPriceVM> stmas_prices, DateTime price_date, DbConnectionConfig db_conn_config)
        {
            foreach (var s in stmas_prices)
            {
                s.SetLastestPrice(price_date, db_conn_config);
            }
        }

        public static bool IsEditableTankSetup(this tanksetupVM tanksetup, DbConnectionConfig db_conn_config, bool show_alert = true)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
        ...
        public static bool IsEditableShiftSales(this shiftsalesVM shiftsales, DbConnectionConfig db_conn_config, bool show_alert = true)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                ...
                if(shiftsales.IsClosedShiftSales(db_conn_config).Value == true)
                {
                    if(show_alert)
                ...
                if(shiftsales.IsApproved(db_conn_config).Value == true)
                {
                    if(show_alert)
        ...
        public static bool IsEditableDayend(this dayendVM dayend, DbConnectionConfig db_conn_config, bool show_alert = true)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                ...
                if (dayend.IsApprovedAll(db_conn_config).Value == true)
                {
                    if (show_alert)
                        XMessageBox.Show("รายการถูกรับรองไปแล้ว ไม่สามารถแก้ไขหรือลบ, ต้องไปยกเลิกการรับรองรายการก่อน", "", MessageBoxButtons.OK, XMessageBoxIcon.Stop);
                    return false;
        ...
        public static bool IsPrintableShiftSales(this shiftsalesVM shiftsales, DbConnectionConfig db_conn_config, bool show_alert = true)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                var sales = db.shiftsales.Find(shiftsales.id);
                ...
                if(settings.shiftprintmet == ((int)PRINT_METHOD.APPROVED_BEFORE_PRINT).ToString() && shiftsales.IsApproved(db_conn_config).Value == false)
                {
                    if (show_alert)
                ...
                if(settings.shiftprintmet == ((int)PRINT_METHOD.PRINT_BEFORE_APPROVED).ToString() && shiftsales.IsApproved(db_conn_config).Value == true)
                {
                    if (show_alert)
        ...
        public static bool IsPrintableDayend(this dayendVM dayend, DbConnectionConfig db_conn_config, bool show_alert = true)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                var de = db.dayend.Find(dayend.id);
                ...
                if (settings.dayprintmet == ((int)PRINT_METHOD.APPROVED_BEFORE_PRINT).ToString() && dayend.IsApproved(db_conn_config).Value == false)
                {
                    if (show_alert)
                        XMessageBox.Show("ต้องรับรองรายการก่อนพิมพ์", "", MessageBoxButtons.OK, XMessageBoxIcon.Stop);
                    return false;
                ...
                if (settings.dayprintmet == ((int)PRINT_METHOD.PRINT_BEFORE_APPROVED).ToString() && dayend.IsApproved(db_conn_config).Value == true)
                {
                    if (show_alert)
                        XMessageBox.Show("รับรองรายการแล้ว ไม่สามารถพิมพ์ได้, ต้องไปยกเลิกการรับรองรายการก่อน", "", MessageBoxButtons.OK, XMessageBoxIcon.Stop);
                    return false;
        ...
        public static PRINT_AUTHORIZE_STATE GetPrintAuthorizeState(this shiftsalesVM shiftsales, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                var sales = db.shiftsales.Find(shiftsales.id);
        ...
        public static PRINT_AUTHORIZE_STATE GetPrintAuthorizeState(this dayendVM dayend, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
                var de = db.dayend.Find(dayend.id);
        ...
        public static bool? IsClosedShiftSales(this shiftsalesVM shiftsales, DbConnectionConfig db_conn_config)
        {
            if (shiftsales == null)
                return null;
        ...
        public static bool? IsApproved(this shiftsalesVM shiftsales, DbConnectionConfig db_conn_config)
        {
            if (shiftsales == null)
                return null;
        ...
        public static bool? IsApproved(this dayendVM dayend, DbConnectionConfig db_conn_config)
        {
            if (dayend == null)
                return null;
        ...
        public static bool? IsApprovedAll(this dayendVM dayend, DbConnectionConfig db_conn_config)
        {
            if (dayend == null)
                return null;
        ...
        public static List<daysttak> GetIncompleteDaysttak(this dayendVM dayend, DbConnectionConfig db_conn_config)
        {
            using (xpumpEntities db = DBX.DataSet(db_conn_config))
            {
